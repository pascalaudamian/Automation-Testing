...
- Name: DraggablePage >> should drag and drop an item in Simple Dragging tab
- Location: C:\Users\damian.pascalau\Projects\automation-test-site\tests\drag-and-drops.spec.ts:17:7
...
Locator: getByTestId('event-log')
Expected string: "Dropped item-1"
Received string: "No events yet"
Call log:
  - expect.toContainText with timeout 5000ms
  - waiting for getByTestId('event-log')
    9 × locator resolved to <div data-testid="event-log" class="h-[400px] overflow-y-auto border rounded-md p-3 space-y-1 text-sm">…</div>
      - unexpected value "No events yet"

    at C:\Users\damian.pascalau\Projects\automation-test-site\tests\drag-and-drops.spec.ts:25:23
```
